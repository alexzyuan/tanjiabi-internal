...
export async function sendFbaDingTalkText(content, { atAll = false, atMobiles = [], atUserIds = [] } = {}) {
  return sendConfiguredDingTalkText(getConfig().dingtalk.fba, content, { atAll, atMobiles, atUserIds }, "FBA_DINGTALK_WEBHOOK");
}
