...
import { createSalesShell } from "./assets/js/sales-shell.js?v=20260717-date-range-picker-v1";
...
import { createFbaFreightFeature } from "./assets/js/features/fba-freight.js?v=20260717-date-range-picker-v1";
