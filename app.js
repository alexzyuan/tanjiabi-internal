...
import { createFbaFreightFeature } from "./assets/js/features/fba-freight.js?v=20260720-jiufang-flow-v2";
...
({ loadFreightRatesInitial, setupFreightRatesDashboard } = createFreightRatesFeature({
  root: document,
  bind,
  closestTarget,
  downloadBlob,
